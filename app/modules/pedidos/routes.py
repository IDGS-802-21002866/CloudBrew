...
def listar():
    ...
    pagination = pedido_service.listar_paginados(page=page, per_page=10, search_term=search_term)
...
def crear():
    ...
    clientes_retail = [c for c in cliente_service.listar_clientes() if c.tipo.lower() == 'retail']
        ...
        if action == "agregar_detalle":
            if detalle_form.validate_on_submit():
                ...
                detalle = {
                    ...
                    "total_unidades": detalle_form.cantidad_lotes.data * receta.cantidad_producida
                }
