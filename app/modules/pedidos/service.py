...
class PedidoService:
    ...
    def crear_pedido(self, data, usuario_id):
        ...
        pedido_repo.save(nuevo_pedido)

        receta_service = RecetaService() # Instancia del servicio de Miguel
        ...
        for detalle in detalles_data:
            ...
            # --- CORRECCIÓN AQUÍ (Línea 43) ---
            # Cambiamos 'obtener_por_id' por 'obtener_receta'
            ...
            pedido_repo.save(detalle_pedido)
    ...
    def cancelar_pedido(self, pedido_id):
        ...
        # Cambiamos el estado en lugar de desactivar
